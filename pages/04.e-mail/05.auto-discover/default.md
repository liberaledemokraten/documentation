...
A proof of concept on how to achieve this may be found in: [liberaledemokraten/php-iOS-email-config](https://github.com/liberaledemokraten/php-iOS-email-config).
